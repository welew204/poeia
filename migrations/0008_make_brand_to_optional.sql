...
INSERT INTO "new_Element" ("brand", "createdAt", "id", "name", "quantity", "type", "unit", "updatedAt", "userId") SELECT "brand", "createdAt", "id", "name", "quantity", "type", "unit", "updatedAt", "userId" FROM "Element";
DROP TABLE "Element";
